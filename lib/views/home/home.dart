...
import 'package:cabonconnet/views/home/create_product.dart';
  ...
  void _showPostOptions(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        height: (profileContoller.currentUserModelRx.value?.role
                    .toLowerCase()
                    .toString() ==
                "founder")
            ? 180
        ...
        child: Column(
          children: [
            ...
            const CustomDivider(),
            if (profileContoller.currentUserModelRx.value?.role
                    .toLowerCase()
                    .toString() ==
                "founder")
              ListTile(
          ...
          items: [
            ...
            BottomNavigationBarItem(
              icon: Obx(() {
                return CircleAvatar(
                  backgroundImage:
                      profileContoller.currentUserModelRx.value?.profileImage != null
                          ? CachedNetworkImageProvider(
                              profileContoller.currentUserModelRx.value!.profileImage!)
